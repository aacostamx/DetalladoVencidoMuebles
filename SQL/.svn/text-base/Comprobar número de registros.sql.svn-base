...
--Solo cambiar el mes Ene2013 por el mes deseado

if exists(select * from sysobjects where name = 'tmpFecha') drop table tmpFecha
select top 1 fechaventa
into tmpFecha
from opendatasource('sqloledb','data source=odscarteras.coppel.com;user id=consultas;password = carteras').Ene2013.dbo.maecarteramuebles order by fechaventa desc
...
into dbo.tmpMueb
from opendatasource('sqloledb','data source=odscarteras.coppel.com;user id=consultas;password = carteras').Ene2013.dbo.maecarteramuebles
