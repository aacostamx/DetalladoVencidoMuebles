...
into tmpFecha
from opendatasource('sqloledb','data source=odscarteras.coppel.com;user id=consultas;password = carteras').sep2013.dbo.maecarteramuebles order by fechaventa desc
